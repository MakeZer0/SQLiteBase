    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                //attemptLogin();
                Cliente cliente = db.buscarCliente(mEmailView.getText().toString());

                if(cliente != null){
                    if(cliente.getSenha() == mPasswordView.getText().toString()){
        ...
        btnCadastro.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(LoginActivity.this,"Cadastro não encontrado", Toast.LENGTH_LONG).show();
            }
        });
